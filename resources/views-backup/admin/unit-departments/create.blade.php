    ...
    <div class="page-container">
        <header class="page-header">
            <div>
                ...
                <p class="subtitle">Buat departemen baru untuk unit</p>
            </div>
        ...
        <form action="{{ route('admin.unit-departments.store') }}" method="POST" id="departmentForm" class="form-layout">
            ...
            <section class="form-card">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="code" name="code" value="{{ old('code') }}" placeholder="Contoh: FT, FE"
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-light" style="color:#ffff; background-color: #FF5625;" id="submitBtn">
                    <span class="btn-text">Add Departemen</span>
