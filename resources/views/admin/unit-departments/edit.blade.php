...
<div class="page-container">
    ...
    <form action="{{ route('admin.unit-departments.update', $department->id) }}" method="POST" id="departmentForm" class="form-layout">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description"
                              name="description"
                              rows="4"
                              placeholder="Deskripsikan departemen ini..."
        ...
        <div class="form-actions">
            <a href="{{ route('admin.unit-departments.index') }}" class="btn-ghost">Batal</a>
            <button type="submit" class="btn btn-primary" id="submitBtn">
                <span class="btn-text">Perbarui Departemen</span>
