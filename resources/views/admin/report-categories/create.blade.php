...
@section('title', 'Add New Rating Category')

@section('admin-content')
    <div class="page-container">
        <header class="page-header">
            <div>
                <h1>Tambah Kategori Rating</h1>
                <p class="subtitle">Buat kategori baru untuk penilaian unit</p>
            </div>
        ...
        <form action="{{ route('admin.rating-categories.store') }}" method="POST" id="categoryForm" class="form-layout">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', 0) }}"
                                placeholder="0" min="0" class="form-input @error('sort_order') is-invalid @enderror">
                            <span class="input-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
