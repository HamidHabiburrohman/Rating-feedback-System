    ...
    <div class="container-fluid px-4 py-4">
            ...
            <div class="d-flex justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <x-admin.button-create url="{{ route('admin.rating-categories.create') }}"
                        tooltip="Add New Rating Category" size="md">Add Category</x-admin.button-create>
                </div>
            </div>
        </div>
        ...
        <div class="card border rounded-5 mt-4">
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody id="categoriesTable">
                        @include('admin.rating-categories.partials.rows', [
            ...
            <div class="px-4 py-3" id="categoriesPaginationContainer">
                @include('admin.rating-categories.partials.pagination', [
