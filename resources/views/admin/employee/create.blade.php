...
@section('content')
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h2 fw-bold mb-0" style="color: #1a1a1a;">Create New Employee</h1>
                ...
                <form action="{{ route('admin.employees.store') }}" method="POST" id="employeeForm">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Enter full name" style="height: 48px; border: 1px solid #e5e7eb;" required>
                                    @error('nama')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('jabatan') is-invalid @enderror" id="jabatan" name="jabatan" value="{{ old('jabatan') }}" placeholder="Enter position" style="height: 48px; border: 1px solid #e5e7eb;" required>
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('bidang') is-invalid @enderror" id="bidang" name="bidang" value="{{ old('bidang') }}" placeholder="Enter field/division" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('bidang')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control rounded-3 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Enter email address" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('telepon') is-invalid @enderror" id="telepon" name="telepon" value="{{ old('telepon') }}" placeholder="Enter phone number" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('telepon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control rounded-3 @error('tanggal_mulai') is-invalid @enderror" id="tanggal_mulai" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('tanggal_mulai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control rounded-3 @error('tanggal_selesai') is-invalid @enderror" id="tanggal_selesai" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" style="height: 48px; border: 1px solid #e5e7eb;">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-3 @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="4" placeholder="Enter additional notes or description..." style="border: 1px solid #e5e7eb;">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
