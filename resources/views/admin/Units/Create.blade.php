    ...
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Add a new unit to the system</p>
            </div>
        </div>
                ...
                <form action="{{ route('admin.units.store') }}" method="POST" id="unitForm">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('kode_unit') is-invalid @enderror" id="kode_unit" name="kode_unit" value="{{ old('kode_unit') }}" placeholder="Enter unit code" style="height: 48px; border: 1px solid #e5e7eb;" required>
                                    @error('kode_unit')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('nama_unit') is-invalid @enderror" id="nama_unit" name="nama_unit" value="{{ old('nama_unit') }}" placeholder="Enter unit name" style="height: 48px; border: 1px solid #e5e7eb;" required>
                                    @error('nama_unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" value="{{ old('lokasi') }}" placeholder="Enter unit location" style="height: 48px; border: 1px solid #e5e7eb;" required>
                                    @error('lokasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('gedung') is-invalid @enderror" id="gedung" name="gedung" value="{{ old('gedung') }}" placeholder="Enter building name" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('gedung')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('lantai') is-invalid @enderror" id="lantai" name="lantai" value="{{ old('lantai') }}" placeholder="Enter floor number" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('lantai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control rounded-3 @error('kapasitas') is-invalid @enderror" id="kapasitas" name="kapasitas" value="{{ old('kapasitas') }}" placeholder="Enter capacity" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('kapasitas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 @error('kontak_telepon') is-invalid @enderror" id="kontak_telepon" name="kontak_telepon" value="{{ old('kontak_telepon') }}" placeholder="Enter phone number" style="height: 48px; border: 1px solid #e5e7eb;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control rounded-3 @error('kontak_email') is-invalid @enderror" id="kontak_email" name="kontak_email" value="{{ old('kontak_email') }}" placeholder="Enter email address" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('kontak_email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control rounded-3 @error('jam_buka') is-invalid @enderror" id="jam_buka" name="jam_buka" value="{{ old('jam_buka') }}" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('jam_buka')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control rounded-3 @error('jam_tutup') is-invalid @enderror" id="jam_tutup" name="jam_tutup" value="{{ old('jam_tutup') }}" style="height: 48px; border: 1px solid #e5e7eb;">
                                    @error('jam_tutup')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-3 @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="4" placeholder="Enter unit description..." style="border: 1px solid #e5e7eb;">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="status_aktif" name="status_aktif" value="1" {{ old('status_aktif', true) ? 'checked' : '' }}>
