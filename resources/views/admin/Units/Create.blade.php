        ...
        <section class="form-card">
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper code-wrapper">
                        <input type="text" 
                               ...
                               name="code" 
                               value="{{ old('code') }}"
                               class="form-input code-input @error('code') is-invalid @enderror"
                               readonly
                               required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <select id="unit_department_id" 
                                name="unit_department_id" 
                            ...
                            @foreach($unitDepartments as $dept)
                                <option value="{{ $dept->id }}" {{ old('unit_department_id') == $dept->id ? 'selected' : '' }}>
                                    {{ $dept->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="form-group full-width" style="margin-top: 1rem;">
                ...
                <div class="status-options">
                    <label class="status-option">
                        <input type="radio" name="operational_status" value="open" {{ old('operational_status', 'open') == 'open' ? 'checked' : '' }}>
                        <span class="status-badge open">Buka</span>
                    </label>
                    <label class="status-option">
                        <input type="radio" name="operational_status" value="maintenance" {{ old('operational_status') == 'maintenance' ? 'checked' : '' }}>
                        <span class="status-badge maintenance">Perawatan</span>
                    </label>
                    <label class="status-option">
                        <input type="radio" name="operational_status" value="closed" {{ old('operational_status') == 'closed' ? 'checked' : '' }}>
        ...
        <section class="form-card">
            ...
            <div class="form-group full-width">
                ...
                <textarea id="description" 
                          name="description" 
                          rows="4"
                          placeholder="Deskripsikan unit ini..."
