    ...
    <form action="{{ route('admin.reports.update', $report->id) }}" method="POST" id="reportForm" class="form-layout">
        ...
        <section class="form-card">
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="form-group full-width">
                    <label for="description" class="form-label">Deskripsi Laporan <span class="required">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
                            <option value="new" {{ old('status', $report->status) == 'new' ? 'selected' : '' }}>Baru</option>
                            <option value="in_progress" {{ old('status', $report->status) == 'in_progress' ? 'selected' : '' }}>Diproses</option>
                            <option value="replied" {{ old('status', $report->status) == 'replied' ? 'selected' : '' }}>Ditanggapi</option>
        ...
        <div class="form-actions">
            <a href="{{ route('admin.reports.show', $report->id) }}" class="btn-ghost">Batal</a>
