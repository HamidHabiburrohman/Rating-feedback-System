...
@section('admin-content')
    <div class="page-container">
        <header class="page-header">
            <div>
                <h1 class="page-title">Add Unit Type</h1>
                <p class="page-subtitle">Create a new category for your facility management system.</p>
            </div>
            ...
            <section class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="selected_icon_key" name="icon_key" value="{{ old('icon_key') }}" required>
                        <div class="icon-picker-wrapper @error('icon_key') is-invalid @enderror" id="iconPickerWrapper">
                            <button type="button" class="icon-picker-trigger" id="iconPickerTrigger">
                                ...
                                <span class="icon-label" id="iconLabel">Select Icon</span>
