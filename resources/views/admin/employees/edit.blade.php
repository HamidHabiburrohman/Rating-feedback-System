    ...
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0 mt-1">Update employee information</p>
            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <div class="photo-preview-wrapper"
                                    style="width: 120px; height: 120px; border-radius: 50%; overflow: hidden; border: 2px dashed #d1d5db; display: flex; align-items: center; justify-content: center; background: #f9fafb; cursor: pointer; position: relative;"
                                    onclick="document.getElementById('photoInput').click();">
                                    @if($employee->photo)
                                        <img id="photoPreview" src="{{ asset('storage/' . $employee->photo) }}" alt="Preview"
                                            style="width: 100%; height: 100%; object-fit: cover;">
                                        <div id="photoPlaceholder" class="text-center" style="display: none;">
                            ...
                            <div class="col-md-10">
                                ...
                                <p class="mb-1 text-muted" style="font-size: 14px;">Click the photo area to upload new photo
                                </p>
                                <p class="mb-0 text-muted" style="font-size: 12px;">Supported formats: JPG, JPEG, PNG (Max
                                    2MB)</p>
                                @error('photo')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $employee->name) }}" placeholder="Enter employee name" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="employee_id" class="form-label fw-medium">Employee ID <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="employee_id" id="employee_id"
                                    class="form-control rounded-3 @error('employee_id') is-invalid @enderror"
                                    value="{{ old('employee_id', $employee->employee_id) }}" placeholder="e.g., EMP001"
                                    required>
                                @error('employee_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone" id="phone"
                                    ...
                                    value="{{ old('phone', $employee->phone) }}" placeholder="+62 812 3456 7890">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="form-control rounded-3" placeholder="Re-enter new password">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="position" id="position"
                                    class="form-control rounded-3 @error('position') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="department" id="department"
                                    ...
                                    value="{{ old('department', $employee->department) }}" placeholder="e.g., Engineering">
                                @error('department')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="timezone" id="timezone"
                                    class="form-select rounded-3 @error('timezone') is-invalid @enderror">
                                    <option value="">Select timezone</option>
                                    <option value="Asia/Jakarta" {{ old('timezone', $employee->timezone) == 'Asia/Jakarta' ? 'selected' : '' }}>Asia/Jakarta (WIB)</option>
                                    <option value="Asia/Makassar" {{ old('timezone', $employee->timezone) == 'Asia/Makassar' ? 'selected' : '' }}>Asia/Makassar (WITA)</option>
                                    <option value="Asia/Jayapura" {{ old('timezone', $employee->timezone) == 'Asia/Jayapura' ? 'selected' : '' }}>Asia/Jayapura (WIT)</option>
                                </select>
                                @error('timezone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mt-2">
                                    ...
                                    <label class="form-check-label" for="is_active">
                                        ...
                                        <span class="text-muted d-block" style="font-size: 12px;">Employee can access the
                                            system</span>
                                    </label>
                                </div>
                                @error('is_active')
