    ...
    <div class="page-container">
        <header class="page-header">
            <div>
                ...
                <p class="subtitle">Buat fasilitas baru untuk unit</p>
            </div>
        ...
        <form action="{{ route('admin.facilities.store') }}" method="POST" id="facilityForm" class="form-layout">
            @csrf
            ...
            <section class="form-card">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="selected_icon_key" name="icon_key" value="{{ old('icon_key') }}">
                        <div class="icon-picker-wrapper @error('icon_key') is-invalid @enderror" id="iconPickerWrapper">
                            <button type="button" class="icon-picker-trigger" id="iconPickerTrigger">
                                ...
                                <span class="icon-label" id="iconLabel">Pilih Ikon</span>
                        ...
                        <span class="help-text">Ikon untuk memudahkan identifikasi fasilitas</span>
                        @error('icon_key')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
