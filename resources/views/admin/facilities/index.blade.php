    ...
    <script>
        ...
        function generateSkeletonRows(count) {
            ...
            <tr>
                ...
                <td><div class="skeleton" style="width: 80px; height: 26px; border-radius: 12px;"></div></td>
                <td><div class="skeleton" style="width: 90px; height: 26px; border-radius: 12px;"></div></td>
                <td class="text-center pe-4">
                    <div class="d-flex justify-content-center gap-2">
                        <div class="skeleton" style="width: 34px; height: 34px; border-radius: 18px;"></div>
                        <div class="skeleton" style="width: 34px; height: 34px; border-radius: 18px;"></div>
                    </div>
                </td>
            </tr>
        ...
        function fetchData(url) {
            const tableBody = document.getElementById('unitTypesTable') || document.getElementById(
                'unitDepartmentsTable') || document.getElementById('facilitiesTable');
            const paginationContainer = document.getElementById('unitTypesPaginationContainer') || document.getElementById(
                'unitDepartmentsPaginationContainer') || document.getElementById('facilitiesPaginationContainer');
