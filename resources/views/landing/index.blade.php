...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            ...
            <div class="hero-meta">
                <div class="meta-item">
                    <span class="meta-num">{{ $statistics['total_units'] ?? 0 }}</span>
                    <span class="meta-label">Units</span>
                </div>
                <div class="meta-divider"></div>
                <div class="meta-item">
                    <span class="meta-num">{{ number_format($statistics['total_members'] ?? 0) }}+</span>
                    <span class="meta-label">Members</span>
                </div>
                <div class="meta-divider"></div>
                <div class="meta-item">
                    <span class="meta-num">{{ $statistics['total_categories'] ?? 0 }}</span>
    ...
    <section class="stats-bar">
        <div class="container">
            <div class="stats-grid">
                <div class="stat-item">
                    <span class="stat-num" data-target="{{ $statistics['total_units'] ?? 0 }}">{{ number_format($statistics['total_units'] ?? 0) }}</span>
                    <span class="stat-label">Active Units</span>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <span class="stat-num" data-target="{{ $statistics['total_members'] ?? 0 }}">{{ number_format($statistics['total_members'] ?? 0) }}+</span>
                    <span class="stat-label">Members</span>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <span class="stat-num" data-target="{{ $statistics['total_categories'] ?? 0 }}">{{ $statistics['total_categories'] ?? 0 }}</span>
        ...
        <div class="split-panel split-dark">
            <div class="split-inner">
                ...
                <p class="split-body">Every year, thousands of new students arrive at ITENAS overwhelmed by choice. With
                    {{ $statistics['total_units'] ?? 0 }} active units spanning robotics, music, sports, and engineering — finding the right fit is harder
                    than it looks.</p>
            ...
            <div class="split-inner">
                ...
                <ul class="check-list">
                    <li class="check-item">
                        ...
                        <span>Centralized profiles for all {{ $statistics['total_units'] ?? 0 }} units with real member reviews and achievement
                            records</span>
                    </li>
                    <li class="check-item">
                        <span class="check-icon">✓</span>
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    <div class="feature-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path
                                d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.71 9m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M1 5 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                    </div>
                ...
                <div class="feature-card">
                    <div class="feature-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path
                                d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-3.17.789 6.721 6.721 0 01-3.168-.789 3.376 3.376 0 016.338 0z" />
                        </svg>
                    </div>
                ...
                <div class="unit-card {{ $index % 2 == 1 ? 'unit-card--reverse' : '' }}">
                    <div class="unit-image-col">
                        <div class="unit-img-wrap">
                            @if($unit->primaryPhoto && isset($unit->primaryPhoto->thumbnail_url))
                                <img src="{{ $unit->primaryPhoto->thumbnail_url }}" alt="{{ $unit->name }}" class="unit-img" loading="lazy" />
                            @elseif(isset($unit->photos) && $unit->photos->isNotEmpty())
                                <img src="{{ $unit->photos->first()->thumbnail_url ?? asset('assets/images/UnitPlaceholder.png') }}" alt="{{ $unit->name }}" class="unit-img" loading="lazy" />
                            @else
                        ...
                        <div class="unit-inner">
                            ...
                            <div class="unit-meta">
                                <div class="unit-rating">
                                    <span class="stars">
                                        @for($i = 1; $i <= $unit->full_stars; $i++)★@endfor
                                        @if($unit->has_half)½@endif
                                        @for($i = 1; $i <= $unit->empty_stars; $i++)☆@endfor
                                    </span>
                                    <span class="rating-num">{{ $unit->rating_display }}</span>
                                </div>
                                <span class="unit-members">{{ number_format($unit->total_ratings ?? 0) }} Reviews</span>
                            </div>
            ...
            <div class="process-grid">
                <div class="process-card">
                    ...
                    <div class="process-content">
                        ...
                        <p class="process-desc">Browse all {{ $statistics['total_units'] ?? 0 }} units. Filter by interest, schedule, and commitment level.
        ...
        <div class="container">
            <div class="cta-inner">
                ...
                <div class="cta-action-col">
                    ...
                    <a href="{{ route('student.register') }}" class="btn-cta-large">GET STARTED NOW</a>
                </div>
            </div>
        </div>
    </section>
