...
@section('admin-content')
    <div class="page-container">
        <header class="page-header">
            <div>
                <h1>Edit Tipe Unit</h1>
                <p class="subtitle">Perbarui informasi tipe unit: {{ $unitType->name }}</p>
            </div>
                ...
                <div class="grid grid-cols-2">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="name" name="name" value="{{ old('name', $unitType->name) }}"
                        ...
                        <div class="input-wrapper">
                            <select id="icon_key" name="icon_key"
                                ...
                                @foreach($icons as $key => $label)
                                    <option value="{{ $key }}" {{ old('icon_key', $unitType->icon_key) == $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                            <span class="input-icon">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Deskripsikan tipe unit ini..."
                            class="form-textarea @error('description') is-invalid @enderror">{{ old('description', $unitType->description) }}</textarea>
                        @error('description')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="slug" name="slug" value="{{ old('slug', $unitType->slug) }}"
